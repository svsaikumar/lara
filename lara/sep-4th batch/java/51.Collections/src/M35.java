...
//set
//not allow duplicates, allow null(only once)
//we can add duplicates(no CTE or RTE)-diplicates will not store inside the set
//
...
//"HasSet" is able to identify the duplicates as hashocode() and equals() got overrided