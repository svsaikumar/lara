...
class M93
{
	public static void main(String[] args) 
	{
		...
		System.out.println("tailMap of 10:" + map.tailMap(new A(23)));//specified element is inclusive
		System.out.println("tailMap of 22:" + map.tailMap(new A(22)));//specified element is inclusive
	}
}
